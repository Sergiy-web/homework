...
function modifyFunction(originalFunction, multiplier) {
  return function (newNum) {
     return originalFunction(newNum) * multiplier;  
  }; 
};
...
/*
 ...
 originalFunction(4) повинно повернути 16 (4 * 4), 
 а modifiedFunc(4) повинно повернути 48, 
 оскільки 16 (результат originalFunction) множиться на 3 (множник у modifyFunction).
*/
