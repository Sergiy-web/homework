...
console.log(result4); // Повинно повернути 24 (2*3*4)
...
/*
 ...
 Всередині deepInnerFunction, вона використовує аргументи arg1, arg2 та arg3. 
 Цікаво, що deepInnerFunction має доступ до аргументів arg1 та arg2, незважаючи на те, що вона знаходиться в різних областях видимості. 
 Це можливо завдяки замиканням в JavaScript.
