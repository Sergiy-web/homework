/*
 ...
 Функція повинна дозволяти послідовне встановлення компонентів доменного імені: протоколу, назви домену та домену верхнього рівня (TLD).
...
function curriedDomain(protocol) {
  return function protocolSetter(example) {
    return function domainNameSetter(com) {
        return `${protocol}://${example}.${com}`;
    }
  }
}
console.log(curriedDomain('http')('home-work')('com'));
