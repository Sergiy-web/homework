...
const doubledArray = doubleArrayElements(exampleArray);
console.log('Double arry:', doubledArray); 
// /*
//  * #3
//  *
...
const skillsManager = new SkillsManager();
skillsManager.addSkill("java");
skillsManager.addSkill("j");
console.log(skillsManager.getAllSkills());
// /*
//  * #4
//  * Задача: Калькулятор дат.
//  * Завдання: Створити модуль на JavaScript, який імплементує 
//  * функцію-конструктор DateCalculator для створення об'єктів, здатних керувати датами. 
//
...
function DateCalculator(initialDate) {
  ...
  this.getResult = function() {
    return this.initialDate.getDate();
  }
}
const dateCalculator = new DateCalculator('2023-01-01');
...
dateCalculator.addDays(5);
dateCalculator.subtractDays(3)
console.log(dateCalculator.getResult()); //3